...
import com.solucius.solucius.security.oauth.MyAuthenticationFailureHandler;
import com.solucius.solucius.security.oauth.MyAuthenticationSuccessHandler;
import com.solucius.solucius.security.jwt.JwtAuthFilter;
import com.solucius.solucius.security.jwt.JwtExceptionFilter;
import com.solucius.solucius.security.oauth.CustomOAuth2UserService;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/token/**","/Signup/**").permitAll() // 토큰 발급을 위한 경로는 모두 허용
